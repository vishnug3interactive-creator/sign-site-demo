...
const TABS = ['Purchase', 'History', 'Notes', 'Tasks', 'Assets', 'Email', 'Related'];
...
<Box key='history' sx={{ position: 'relative' }}>
  ...
  return (
    <>
       <Box sx={{ width: '100%',height:'100vh',borderRadius:'12px',backgroundColor:'white',marginTop:'1.5rem' }}>
            <Tabs
                value={selectedTab}
            ...
            >
              ...
              <Box sx={{ p: 2, height: '40rem', overflow: 'auto' }}>{tabContents[selectedTab]}</Box>
